...
stat <- imap(c("Luminal_gr", "Tissue_gr"), ~test.krusk_dunn.fun(cytogr.long, Cytokines, .x))
s <- flatten(stat)
write.xlsx(s, file=paste0("../../../results/","Cytokine_stats",".xlsx"))
...
**Figure 3. Protein Heatmap**. **a** and **c** Without scaling (normalized MFI), for Luminal and Tissue respectively **b** and **d** scaled by row for Luminal and Tissue respectively. top dpe with p-value < 0.05
