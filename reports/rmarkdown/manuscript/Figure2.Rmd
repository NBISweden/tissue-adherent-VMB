...
### B
###################################
# WETT SMEAR BACTERIAL VALIDATION #
###################################
...
mtext("Wett Smear Bacteria Validation", side=3, las = 1, cex = .6, line =1.5,xpd=T, font = 2)
...
mtext("Differentialy Expressed KEGG Ontology Terms", side=3, las = 1, cex = .6, line =1.5,xpd=T, font = 2)
...
map2(t,levels(factor(group_annotation)), ~text(x=.x, y=1.043, .y,xpd=T, cex=.8))
