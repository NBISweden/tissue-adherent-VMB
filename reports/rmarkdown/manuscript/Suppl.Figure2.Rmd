---
title: "Suppl. Figure 2. Differential bacterial abundance across tissue and CVL microbiome"
output: 
  pdf_document:
    fig_caption: yes
    keep_tex: yes
...
```{r Suppl. Figure 9, eval=T,warning=FALSE, message=FALSE,echo = FALSE,fig.width=10,fig.height=9}
...
#par(mar=c(2,17,1,2)) #b,l,t,r
plot_dots( all_microbiome , names(sort(ord)) , clustering = datasets,
