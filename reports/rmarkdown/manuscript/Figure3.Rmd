...
```{r Figure 3., echo=FALSE, warning=FALSE, message=FALSE, fig.width=6 ,fig.asp=1, fig.pos="t"}
### A + B
#############################
...
layout(matrix(c(1,1,1,1,1,1,
                ...
                3,3,6,7,4,4,
                3,3,6,5,4,4,
                8,8,8,8,8,8) , ncol= 6,byrow = T),
                               widths = c(1.2,1,1.83,1.7,.85,1.4),
                               heights = c(.7,1.5,.8,1.5,1,.8,.2))
