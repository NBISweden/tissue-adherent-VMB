...
\hypertarget{figure-s14}{%
\subsection{Figure S14}\label{figure-s14}}

\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-25-1}

\clearpage

\hypertarget{figure-s15}{%
\subsection{Figure S15}\label{figure-s15}}

\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-26-1}
\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-26-2}
\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-26-3}
\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-26-4}
\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/unnamed-chunk-26-5}

\begin{center}\includegraphics[width=1\linewidth]{manuscript_template_files/figure-latex/Print rare curves-1} \end{center}

\textbf{Supp. Figure 10. Rarefraction curves}. \textbf{A} Boston 1 sequencing run, \textbf{B} Sthlm sequencing run and \textbf{C} and \textbf{D} shows Boston sequencing run 2 split in two plots showing the CVL visit 2 samples and the the TISSUE visit 3 samples respectively
