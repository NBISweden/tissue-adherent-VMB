...
#Graph construction  
k <- 10 # k for KNN
P <- 0.5# prunning threshold of SNN
...
g <- graph_from_adjacency_matrix(snnm,mode = "undirected",diag = F,weighted = T)
...
# k=10
# P=0.1
snn <- dbscan::sNN(x = as.dist( (1-cors)/2 ), k = k, jp = FALSE, approx = TRUE)
snnm <- matrix(0, nrow(snn$id), nrow(snn$id))
snnj <- matrix(0, nrow(snn$id), nrow(snn$id))
