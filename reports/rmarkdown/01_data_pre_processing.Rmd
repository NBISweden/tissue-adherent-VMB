...
# raw files
n <- c("ASV_CVL_V3", "ASV_tissue_V3", "ASV_CVL_V2")
map2(datasets[1:3],n,  ~write.csv(.x, file=paste0(PATH,"results/",.y,"_raw_counts.csv"),row.names = T) )
